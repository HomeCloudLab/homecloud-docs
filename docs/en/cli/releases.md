...
| Version | Highlights |
|---------|------------|
| v0.2.52 | `containers scale` / `force-redeploy` / `rollback` / `deployments`; needs SDK 0.5.20 |
| v0.2.51 | `containers` (list/create/get/delete/tasks/revisions/logs) via JWT → `compute.{apex}`; needs SDK 0.5.19 |
