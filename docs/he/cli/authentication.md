...
ההרשאות תמיד מגיעות מ**מדיניות וקבוצות IAM** של הזהות (ADR-053). ה-Access Key עצמו לא נושא מטריצת הרשאות. סקירה: [ארכיטקטורת אימות](../guides/authentication-architecture.md).
