...
| אזור | התנהגות |
|------|----------|
| **טווח תאריכים** | החודש, חודש קודם, 7 ימים, 30 ימים, או `from`/`to` מותאם |
| **Estimate** | שימוש × מחירון ל**טווח שנבחר** (למשל עלות שימוש משוערת · 7–13 באוג׳) |
| **Forecast** | תמיד **החודש הקלנדרי השוטף** (קצב ריצה + שעות RUNNING שנותרו) |
| **עלות לאורך זמן** | סדרה יומית מבאקטים שעתיים של Meter × מחירים |
| **לפי שירות** | סה״כ Meter × מחירים (גרף עמודות + טבלה) |
| **חשבוניות** | הפקה לפי דרישה; סימון שולם ידני |
| **התראות הוצאה** | יצירה / עריכה / השבתה / מחיקה; חלון חודש או שבוע |
