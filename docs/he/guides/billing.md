...
כרטיס אחד מתחת ל-Glance: טווח תאריכים + יום / שבוע / חודש, ואז גרף העלות. הבקרות משפיעות **רק** על הגרף ועל כרטיס הפירוט שמתחתיו.

| אזור | התנהגות |
|------|----------|
| **טווח תאריכים** | לוח שנה (presets + מותאם). ימי חיוב לפי UTC. |
| **Granularity** | **יום** / **שבוע** / **חודש** (שבוע = שבוע UTC שמתחיל ביום שני, מצבירה יומית) |
| **עלות לאורך זמן** | באותו כרטיס Explorer עם הבקרות. עמודות מוערמות **לפי שירות**. לכל תקופה **רוחב קבוע** (הגרף הפנימי נגלל הצידה). בתצוגה חודשית מוצגים **לפחות 6 חודשי UTC** (ריפוד `$0`). |
