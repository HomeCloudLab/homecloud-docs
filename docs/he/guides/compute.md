...
המכונה יכולה להחזיק **ארבעה** זרמי PTY במקביל כדי ש**סשן** ועד **שלושה** טרמינלים משולבים ב-VS Code יוכלו לרוץ יחד. זרמים נוספים נדחים. Park/reattach לטאבים רבים במנוחה הוא שינוי עתידי; בפאנל VS Code יש כמה טאבים חיים עם **+**, שינוי גודל, ו-**Ctrl+J** להצגה/הסתרה (סגור כברירת מחדל).
