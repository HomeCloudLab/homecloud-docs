...
| סקריפטים, CI, אפליקציות, `homecloud so` / `mq` / Terraform | **Access Key** ID + secret, או GitHub OIDC ל-Terraform | העלאת אובייקטים, פרסום הודעות, invoke לפונקציות, פרוויז'ן של משאבי חשבון |
